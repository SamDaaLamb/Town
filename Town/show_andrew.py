...
while running:
    ...
    si = pygame.Rect(2480+camera[0], 310+camera[1], 270, 8)
    tw = pygame.Rect(1810 +camera[0], 85 + camera[1], 115,8)
    mw = pygame.Rect(1760 + camera[0], 1010 + camera[1], 115, 8)
    bw = pygame.Rect(2290 + camera[0], 2055 + camera[1], 105, 8)
    ...
    #
    print(r.collidedictall(boarders, rect_values))
