...
"fwd-2":pygame.transform.scale_by(pygame.image.load("fwd-2.gif"),0.1),
...
while running:
    ...
    if pressed[pygame.K_UP] or pressed[pygame.K_w]:
        screen.blit(draw_b, ((500, 300)))


    if pressed[pygame.K_LEFT] or pressed[pygame.K_a]:
        screen.blit(player.get("left-1"), ((500, 300)))
    if pressed[pygame.K_DOWN] or pressed[pygame.K_s]:
        screen.blit(draw_f, ((500, 300)))

    if pressed[pygame.K_RIGHT] or pressed[pygame.K_d]:
        screen.blit(draw_r, ((500, 300)))
    # Character
    #     if pressed[pygame.]
    #     if pressed[pygame.K_UP] or pressed[pygame.K_w]:
    if camera[1] != 0:
