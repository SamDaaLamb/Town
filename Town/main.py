...
borders = {
    "silo_house": [[-330.0, -35.0], [-530.0, -400.0 ]]# 400is top, -35 left
}
...
def boarder_control():
    ...
    for key in borders:
        ...
        if (pressed[pygame.K_DOWN]) and (
                borders[key][1][1] > total_cam[1] and borders[key][1][0] < total_cam[1]) and (
                borders[key][0][0] < total_cam[0] and borders[key][0][1] > total_cam[0]):

            cam_move = (0, 5)

        elif (pressed[pygame.K_UP]) and (
                borders[key][1][0] < total_cam[1] and borders[key][1][1] > total_cam[1]) and (
                borders[key][0][0] < total_cam[0] and borders[key][0][1] > total_cam[0]):
            cam_move = (0, -5)

        elif (pressed[pygame.K_l]) and (borders[key][1][0] < total_cam[1] and borders[key][1][1] > total_cam[1]) and (
                borders[key][0][0] < total_cam[0] and borders[key][0][1] > total_cam[0]):

            cam_move = (-5, 0)

        elif (pressed[pygame.K_r]) and (borders[key][1][0] < total_cam[1] and borders[key][1][1] > total_cam[1]) and (
                borders[key][0][0] < total_cam[0] and borders[key][0][1] > total_cam[0]):
            cam_move = (5, 0)
        else:
            cam_move = (0, 0)
